...
public class ImageController {
    ...
    public ApiResponse upload(@ApiParam(value = "图片文件", required = true) @RequestParam("file") MultipartFile file,
        ...
        return imageService.upload(file, title, provinceCode, cityCode, districtCode, description, tags, uploader);
    }
    ...
    @PostMapping("/update")
    @ApiOperation(value = "更新图片", notes = "使用 multipart/form-data 提交；除 id 外其余参数均可选，仅更新已提供的字段；三个行政区划代码不允许修改。")
